...
配布ファイル名を `discord-media-exporter-0.5.0-chrome.zip` とした例です。

### Windows PowerShell

```powershell
Get-FileHash .\discord-media-exporter-0.5.0-chrome.zip -Algorithm SHA256
```

### macOS

```bash
shasum -a 256 discord-media-exporter-0.5.0-chrome.zip
```

### Linux

```bash
sha256sum discord-media-exporter-0.5.0-chrome.zip
```
...
- `.output/discord-media-exporter-0.5.0-chrome.zip`
- `.output/discord-media-exporter-0.5.0-chrome.zip.sha256`
